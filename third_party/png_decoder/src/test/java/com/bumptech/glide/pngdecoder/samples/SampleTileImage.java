...
public class SampleTileImage {
  ...
  public static void doTiling(String tiles[], String dest, int nTilesX) {
    ...
    imi2 =
        new ImageInfo(imi1.cols * nTilesX, imi1.rows * nTilesY, imi1.bitDepth, imi1.alpha,
    ...
    for (int ty = 0; ty < nTilesY; ty++) {
      ...
      for (int row1 = 0; row1 < imi1.rows; row1++, row2++) {
        for (int tx = 0; tx < nTilesXcur; tx++) {
          ...
          System.arraycopy(line1.getScanline(), 0, line2.getScanline(), line1.getScanline().length
              * tx, line1.getScanline().length);
        }
  ...
  public static void main(String[] args) {
    doTiling(new String[] {"t1.png", "t2.png", "t3.png", "t4.png", "t5.png", "t6.png"},
        "tiled.png", 2);
