...
import com.bumptech.glide.pngdecoder.IPngWriterFactory;
...
public class WriterFiltersPerformance {
  ...
  public static String processDir(File dir, IPngWriterFactory writerFactory, int repeat,
  ...
  public static String processFile(File f, IPngWriterFactory writerFactory, int repeat,
      boolean showFileName) {
